<div class="d-flex flex-column p-3 sidebar" style="width: 250px; height: 100vh; background-color: #f8f9fa;">
    <!-- Nama Aplikasi -->
    <h5 class="text-center fw-bold text-dark mb-3">NAMA APLIKASI</h5>

    <!-- Dashboard -->
    <div class="mb-2">
        <a class="d-flex justify-content-between align-items-center text-secondary text-decoration-none" data-bs-toggle="collapse" href="#dashboardMenu">
    ...
    <div class="mb-2">
        ...
        <div class="collapse" id="dataMasterMenu">
            ...
            <a href="#" class="d-flex align-items-center text-secondary text-decoration-none py-2">
                <i class="bi bi-people me-2"></i> Manajemen Latihan
            </a>
            <a href="#" class="d-flex align-items-center text-secondary text-decoration-none py-2">
                <i class="bi bi-people me-2"></i> Manajemen Result
            </a>
            <a href="#" class="d-flex align-items-center text-secondary text-decoration-none py-2">
                <i class="bi bi-people me-2"></i> Manajemen Rekomendasi Workout
            </a>
        </div>
    </div>
