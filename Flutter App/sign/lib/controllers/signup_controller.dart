...
class SignupController extends GetxController {
  ...
  static TextEditingController passwordConfirmController = TextEditingController(); // Tambah ini

  void register() {
    String email = emailController.text.trim();
    String password = passwordController.text.trim();
    String passwordConfirm = passwordConfirmController.text.trim(); // ambil benar
