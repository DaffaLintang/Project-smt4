          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 25),
                Expanded(child: buildButton("RESET", () {
                  setState(() {
 ...
 Widget buildTextField(String label, TextEditingController controller) {
  return TextField(
    ...
    decoration: InputDecoration(
      labelText: label,
      contentPadding: EdgeInsets.symmetric(vertical: 7, horizontal: 12), // Mengurangi tinggi
...
Widget buildDropdown() {
  return DropdownButtonFormField<String>(
    ...
    isExpanded: true,
    decoration: InputDecoration(
      contentPadding: EdgeInsets.symmetric(vertical: 7, horizontal: 12), // Mengurangi tinggi input
 ...
 Widget buildButton(String text, VoidCallback onPressed) {
  return ElevatedButton(
    style: ElevatedButton.styleFrom(
      ...
      minimumSize: Size(double.infinity, 36), // Menetapkan tinggi minimum tombol
    ),
    onPressed: onPressed,
